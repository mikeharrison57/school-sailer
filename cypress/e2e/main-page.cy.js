...
describe('main page', () => {
  ...
  it.only('Should be able to navigate to a different school pages based on user state selection.', () => {
    ...
    cy.intercept(`${primaryUrl}school.state=CO&${secureKey}`, {fixture: 'colorado-schools'})
